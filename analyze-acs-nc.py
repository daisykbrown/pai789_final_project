...
for geo in ['tracts','bgs']:
    ...
    res['second_lang_poor_pct'] = 100*res['all_eng_second_poor']/ res['all_eng_all']
...
county_file = "../GIS/US Census County Tiger File/tl_2019_us_county/tl_2019_us_county.shp"
...
nc.to_file(out_file,layer='county',index=False)
